...
const BergProducts = () => {
  ...
  const featuredProducts = bergProducts
    .filter(product => product.isBestSeller || product.isEditorsPick || product.id <= 105)
    .slice(0, 5);
    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold">BERG Leksaker</h2>
          ...
          <div className="hidden md:block">
            <Button variant="outline" asChild>
              <Link to="/produkter?category=Leksaker%20%26%20Pedagogiska%20artiklar">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {featuredProducts.map(product => (
            <a 
              ...
              onClick={() => {
                console.log(`Product click: ${product.name} from BERG SE`);
              }}
            >
