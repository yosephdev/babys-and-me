...
import { babylandProducts } from "@/data/babylandProducts";

const BabylandProducts = () => {
  // Select 5 featured products
  const featuredProducts = babylandProducts
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold">Babyland Produkter</h2>
            <p className="text-gray-600 mt-2">
              Klassiska leksaker och spel för hela familjen
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {featuredProducts.map(product => (
            <a 
              ...
              onClick={() => {
                console.log(`Product click: ${product.name} from Babyland`);
              }}
            >
...
export default BabylandProducts;
