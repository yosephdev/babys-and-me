...
export const products: Product[] = [
  // Clothing & Accessories
  {
    ...
    image: "https://placehold.co/400x400/soft-blue/white?text=Winter+Jacket",
  ...
  // Feeding Supplies
  {
    ...
    image: "https://placehold.co/400x400/soft-yellow/white?text=Baby+Bib",
  ...
  // Toys & Educational Items
  {
    ...
    image: "https://placehold.co/400x400/soft-blue/white?text=Wooden+Blocks",
  ...
  // Nursery Essentials
  {
    ...
    image: "https://placehold.co/400x400/soft-blue/white?text=Stroller",
    retailer: "Bugaboo SE",
